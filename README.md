...
## Описание
<p>
  Проект FeedbackBook собирает отзывы пользователей на произведения. Сами произведения в FeedbackBook не хранятся, здесь нельзя посмотреть фильм или послушать музыку.
...
```
git clone git@github.com:VanZep/FeedbackBook.git
```
